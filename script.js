...
if (currentPDF === 1) {
currentPDF = 2;
pdfViewer.src = "ProyectoED\_corte2of.pdf";
...
preguntaDiv.innerHTML = `<p>${pregunta}</p>       <input type="radio" name="respuesta${index}" value="1"> ${respuestaCorrecta}<br>       <input type="radio" name="respuesta${index}" value="0"> ${respuestaIncorrecta}<br>`;
